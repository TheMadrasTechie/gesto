"""
Gesto full body + hands — detect.

Self-contained detect script for the full region (dim 258).
...
def main():
    ap = argparse.ArgumentParser(description="Live full gesture detection")
    ap.add_argument("artifacts", nargs="?", default="artifacts_full",
    ...
    print(f"full model: {labels} (T={T}, normalize={use_norm})")
